 ...
 * @author Emmanuel E
 */
public class load_eligible_for_vl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
         ...
         dbConnweb conn= new dbConnweb();
             ...
             String sps[]={"internal_system.sp_get_eligible_missing_vl"};
             
         String dbnames[]={"all_patients"};
        ...
        while (conn.rs.next()) {
         ...
         masterarr.put(tablesarr);
          ...
          // System.out.println(""+jarr); 
            ...
            Logger.getLogger(load_eligible_for_vl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
