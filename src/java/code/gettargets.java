...
public class gettargets extends HttpServlet {
    ...
    int numberOfWeeks = (ordinalDay - weekDay + 10) / 7;
            ...
            String getfacils="SELECT id,facility,year,positive_tg,treatment_tg,viralload_tg,timestamp FROM  targets_rri order by id";
            ...
            jobj.put("treatment_tg",conn.rs.getString("treatment_tg"));
            jobj.put("viralload_tg",conn.rs.getString("viralload_tg"));
