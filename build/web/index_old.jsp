...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <h5 style="text-align: center;color:blue;">HTS RRI v 1.3.0</h5>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="btn-group btn-group-justified">
                       ...
                       <a class="btn btn-primary col-sm-3" title="Excel report" href="reports.jsp">
...
<div class="modal" id="excelreport">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form  id="excelreportsfom" method="post" action="reports">
                                <div class="control-group" style="display:none;">
                  ...
                  <div class="control-group" style="display:none;">
                   ...
                   <!-- <div class="control-group" >
                                ...
                                <div class="control-group">
                                    <label></label>
                                    <div class="controls">
                                        <button onclick=" return getreport();" id="excelreportbtn"   style="margin-left: 30%;"  class="btn-lg btn-info active">
                                            Generate
                                        </button>
...
<!--                   <script type="text/javascript" charset="utf-8" src="cordova-1.5.0.js"></script>  -->
                <script>
              var hostname="https://hsdsacluster2.fhi360.org:8443";
...
function getcounsellorslist(){
              ...
              $.ajax({
                    url:hostname+'/hsdsarri/getcancellors',                            
                    type:'get',  
                    dataType: 'json',  
                    success: function(data) {
...
var dailydatadb = new PouchDB('weekly_data_rrisep',{auto_compaction: true});
var remoteCouch = false;
var weeklydata;
...
// $("#viralload_mothers").val(doc.viralload_mothers);
     ...
     //$('#facilityname').chosen();
             //  $('#facilityname').trigger("chosen:updated");
              ...
              // $('#counsellor').chosen();
               //$('#counsellor').trigger("chosen:updated");
...
//            else {skipexporting=0;}
        ...
        if(skipexporting===0){
            ...
            updatesyncstatus(dat.doc._id,'Yes');
             ...
             $.ajax({
                         url:hostname+'/hsdsarri/importweeklydata',                            
                        type:'get', 
data:{id:dat.doc._id,
...
//    var exelend=$("#enddaterpt").val();
  ...
  function downloadrpt(startdate,enddate,cnty,rpttypeurl){
                ...
                var ur=hostname+"/hsdsarri/"+rpttypeurl+"?startdate=" + startdate + "&enddate=" + enddate+ "&county=" + cnty ;
 console.log(ur);
