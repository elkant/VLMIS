...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <h5 style="text-align: center;color:blue;">HTS RRI v 2.0.1</h5>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="btn-group btn-group-justified"> <a href="https://hsdsacluster2.fhi360.org:8443/htsrri/index.jsp" id='refreshpage' class="btn btn-primary col-sm-3"> <i class="glyphicon glyphicon-save"></i> <br>Open  Data Entry Page </a>
...
<!--                       <a class="btn btn-primary col-sm-3" title="Excel report" data-toggle="modal" href="#excelreport">
                    ...
                    <div class="panel">
                        <ul class=" nav nav-tabs " id="myTab">
                            <li class="active newdata col-xs-12"><a href="#dataentry" id="newdatabutton" data-toggle="tab">  <i class="glyphicon glyphicon-stats"></i> reports</a></li>
