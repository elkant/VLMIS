...
<head>
  ...
  <link rel="shortcut icon" href="htsrri.png" width="20px" />
...
<!--  <div class="logo" style="height:70px; width:400px; margin-left: 30%; margin-top: 0%">
  ...
  <div style="margin-left: 38%;">
      <div style="margin-right:25% ;">
          <h3 style="color:#4b8df8;font-family: cambria;text-align: left;font-size: 22px; font-weight: bold;"><b>DAILY HTS LIVE SYSTEM</b></h3> 
    ...
    <form action="login" class="form-vertical login-form" method="post" style="">
      ...
      <div class="alert alert-error hide">
        ...
        <span>Enter your IMIS username and password.</span>
      </div>
      <div class="control-group">
        ...
        <div class="controls">
          <div class="input-icon left">
            <i class="icon-user"></i>
            <input style="height:40px;" class="m-wrap placeholder-no-fix" required="true" type="text" placeholder="Username" value="" name="username"/>
          </div>
        </div>
      </div>
      <div class="control-group">
        ...
        <div class="controls">
          <div class="input-icon left">
            <i class="icon-lock"></i>
            <input style="height:40px;" class="m-wrap placeholder-no-fix" required="true" type="password" placeholder="Password" value="" name="password"/>
          </div>
        </div>
      </div>
      <div class="form-actions">
       
        <input type="submit" class="btn green" input value="Login">
...
<!--      <div class="well">
    ...
    <!-- END REGISTRATION FORM -->
                        ...
                        <img src="images/aphia_logo.png" style="border:1px solid #cbcdcc; padding:1%; width:350px;margin-left: 0%;"  />
