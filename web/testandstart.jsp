...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <h5 style="text-align: center;color:blue;">Test and Start v 3.0.0</h5>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="btn-group btn-group-justified">
                       ...
                       <a class="btn btn-primary col-sm-3" title="Excel report" href="index.jsp">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="width:100%;">
                            <form class="form form-vertical" action="#" method="post" id="weeklydataform">
                                ...
                                <tr><th class="col-xs-12" style="text-align:center"><b>Enter Test and Start Data</b></th></tr>
...
<!--                                <tr>
                                   ...
                                   <div class="control-group col-xs-12" style="border: 0.5px dotted #2e6da4;">
                                    ...
                                    <div class="controls col-xs-9">
                                        <select type="text"  onchange='callCCC();' name="foundcccno" id="foundcccno" autocomplete="off"  class="form-control" >
                                            <option value=''>Loading CCC no</option>
                                            
                                        </select>
                                  
                                    </div>
                                    <div  class="col-xs-3"><input type='checkbox' id='showtypedccc' onclick='togglecccno();'> Type CCC no</div>
                                </div>
...
<!--                                <tr class='cccno' style='display:none;'>
                                    <td class="col-xs-12">-->
                                   <div class="control-group col-xs-12 cccno" style="border: 0.5px dotted #2e6da4;display:none;">
                                    <label class="col-xs-12"><font color="red"><b>*</b></font> Type CCC No</label>
                                    <div class="controls col-xs-12" style="padding-bottom: 15px;">
                                        <input type="text"  onblur="" name="cccno" id="cccno"  autocomplete="off"  class="form-control"  placeholder="e.g 45654-12345">
...
<!--                                <tr>
                                    <td class="col-xs-12">-->
                                   <div class="control-group col-xs-12" style="border: 0.5px dotted #2e6da4;">
                                    <label class="col-xs-12"><font color="red"><b>*</b></font> Date Client was tested for HIV </label>
                                    <div class="controls col-xs-12" style="padding-bottom: 15px;">
                                        <input type="text"  onblur="" name="hivtestdate" id="hivtestdate" data-date-end-date="0d" autocomplete="off"  class="form-control dates" readonly placeholder="e.g yyyy-mm-dd">
...
<!--                                 <tr>
                                    <td class="col-xs-12">-->
                                   <div class="control-group col-xs-12 " style="border: 0.5px dotted #2e6da4;">
                                    <label class="col-xs-12"><font color="red"><b>*</b></font> Transfer in</label>
                                    <div class="controls col-xs-12" style="padding-bottom: 15px;">
                                        <select onchange="decideref();" type="text"  onblur="" name="ti" id="ti"  autocomplete="off"  class="form-control" >
...
<!--                                <tr style='display:none;' class='rf'>
                                    <td class="col-xs-12">-->
                                   <div class="control-group col-xs-12 rf" style="border: 0.5px dotted #2e6da4;display:none;">
                                    <label class="col-xs-12"><font color="red"><b>*</b></font>Facility Reffered from</label>
                                    <div class="controls col-xs-12">
                                        <input type="text"  onblur="" name="rf" id="rf"  autocomplete="off"  class="form-control" >
...
<!--                                </td>
                                ...
                                <div class="control-group col-xs-12">
                                        <div class="alert-info" id='savedresponse'>Note: Please enter data for all input fields.</div>
                                   <br/>
                                    <div class="controls">
                                        <button type="submit" id='savebutton' onmouseover="validatedata();" onclick="validatedata();" style="margin-left: 0%;" class="btn-lg btn-success active">
                                            SAVE
                                        </button>
                                     </div>
                                    <div class="controls">
...
<table class='table table-striped table-bordered' id="reportstable" >
                    ...
                    <!--/panel-->
                            ...
                            <div class="tab-pane well" id="viewcounsellors">
                                 <button id="btnDeleteRowcns" style='display:none;' value="cancel">Delete selected Clinician</button>
...
var ccc="<option value=''>Select CCC no</option>";
   ...
   getCCCNos();
    ...
    var userdb = new PouchDB('activecliniciandetails');
...
function adduser(code,cname,cfacil,fullname) {
  ...
  userdb.put(userdetails, function callback(err, result) {
    if (!err) {
      console.log('clinician added succesfully');
    }
    else{
        console.log(err);
...
if(da.total_rows===0){
    //activatecounsellors();
$("#usernamelabel").html("Activate a Clinician");
$("#usernamelabel").click();
$("#usernamelabel").click();
            ...
            var counsellors="<option value=''>select  Clinician</option>";
            var a;
     for(a=0;a<da.total_rows;a++){
          ...
          $('#counsellor').select2(); 
           ...
           user=dat.cname;
             ...
             counsellors="<option value=''>Activate a Clinician</option>";
             $("#counsellor").html(counsellors);
     }
...
var counsellorslistdb = new PouchDB('clinicianlist_rriv2');
var remoteCouch = false;
...
var dailydatadb = new PouchDB('testandstartdata',{auto_compaction: true});
var remoteCouch = false;
var weeklydata;

//receive the artist, song title and lyrics text
function insertdailydata(id,facilityname,counsellor,register_no,serialno,date_tested,age,gender,modality,testresult,linked,cccno,linked_site,other_facility_linked,reason_not_linked,reason_for_death,other_reason_for_death,reason_for_declining,other_reason_for_declining,timestamp,user,syncstatus) {
...
alert("No loaded list of counsellors");
            ...
            var counsellors="<option value=''>select  Clinician(s)</option>";
            var a;
     for(a=0;a<da.total_rows;a++){
                var dat={}; 
           ...
           counsellors+="<option data-code='"+dat._id+"' data-fullname=\""+dat.fullname+"\" value='"+dat.fullname+"'>"+dat.fullname+"-"+dat._id+" ["+dat.Currentfacility+"]</option>"
          ...
          $('#counsellorreg').css('width','100%'); 
             ...
             //alert("");
             console.log("Skipped Clinician without rri name "+dat.RRI_Name);
     }
...
//else if(modality==='') { alert(' Select modality');  $('#modality').focus(); }
...
else if(  reason_not_linked==='Died' && reason_for_death==='') { alert('Specify reason for death');  $('#reason_for_death').focus();  }
else if( reason_for_death==='Other natural causes' && other_reason_for_death==='') { alert('Specify  other reason for death');  $('#other_reason_for_death').focus(); }
else if(reason_not_linked==='Declined' && reason_for_declining==='') { alert(' Select reason for declining');  $('#reason_for_declining').focus();  }
  ...
  insertdailydata(id,facilityname,counsellor,register_no,serialno,date_tested,age,gender,modality,testresult,linked,cccno,linked_site,other_facility_linked,reason_not_linked,reason_for_death,other_reason_for_death,reason_for_declining,other_reason_for_declining,timestamp,user, syncstatus) ;
  console.log(id+" @ "+facilityname+" @ "+counsellor+" @ "+register_no+" @"+serialno+" @ "+ date_tested+" @ "+age+" @ "+gender+" @ "+modality+" @ "+testresult+" @ "+linked+" @ "+cccno+" @ "+linked_site+" @ "+other_facility_linked+" @ "+reason_not_linked+" @ "+ reason_for_death+"@"+ other_reason_for_death+"@"+ reason_for_declining+"@"+ other_reason_for_declining+"@"+ timestamp+"@"+ user+"@"+ syncstatus) ;
...
function selectsearchdata()
{
  ...
  dailydatadb.allDocs({include_docs: true, ascending: true}).then( function(doc) { 
	   ...
	   for(b=0;b<doc.total_rows;b++)
		 ...
		 dbdata+="<tr id=\""+dat.doc._id+"\"><td> "+dat.doc.date_tested+" </td><td> Facility: <b>"+dat.doc.facility+"</b> Modality: <b>"+dat.doc.modality+"</b> serial #: <b>"+dat.doc.serialno+" </b> Register #: <b>"+dat.doc.register_no+"</b> </td><td><button class='btn-info' onclick='loadsaveddailydata(\""+dat.doc._id+"\",\""+dat.doc.facility+"\",\"no\")'>Edit "+statusicon+"</button></td></tr>";
...
//else if(modality==='') { alert(' Select modality');  $('#modality').focus(); }
 ...
 saveweeklyupdates(id,facilityname,counsellor,register_no,serialno,date_tested,age,gender,modality,testresult,linked,cccno,linked_site,other_facility_linked,reason_not_linked,reason_for_death,other_reason_for_death,reason_for_declining,other_reason_for_declining,timestamp,user, syncstatus) ;
...
function saveweeklyupdates(id,facilityname,counsellor,register_no,serialno,date_tested,age,gender,modality,testresult,linked,cccno,linked_site,other_facility_linked,reason_not_linked,reason_for_death,other_reason_for_death,reason_for_declining,other_reason_for_declining,timestamp,user, syncstatus) {
...
function callCCC(){
        ...
        $.ajax({
                    url:'pulltestandstartdata?cccno='+cccn,                            
                    type:'get',  
                    dataType: 'json',  
                    success: function(data) {
...
function validatedata(){
    ...
    var sd=$("#hivtestdate").val();
    var ed=$("#artstartdate").val();
    var ti=$("#ti").val();
    var rf=$("#rf").val();
    var selectedcccno=$("#foundcccno").val();
    var typedcccno=$("#cccno").val();
    
         if(sd===''){alert("Enter date client was tested for HIV");  }
    else if(ed===''){alert("Enter date client was started on ART");  }
    
            else if(Date.parse(sd) > Date.parse(ed)){
                    alert("Date Started on ART cannot be greater than date tested.");   
                    $("#artstartdate").focus();  
                }
                
                 else if(selectedcccno==='' && typedcccno==='')
                 {
                     alert("Enter clients CCC Number");  
                 }
                  else if(ti==='')
                 {
                     alert("Specify if the client is a transfer in");  
                 }
                 
                  else if(ti==='Yes' && rf==='')
                 {
                     alert("Specify where the client was reffered from");  
                 }
  ...
  function savedata(){
    ...
    var typedcccno=$("#cccno").val();
        ...
        if(selectedcccno!==''){ finalcccno=selectedcccno; }
        else if(typedcccno!==''){ finalcccno=typedcccno; }
        else { finalcccno='no ccc no'; }
        
        
   $.ajax({
                    url:'savetestandstart',                            
                    type:'get',
                    data:{
                        tesd:sd,
                        artd:ed,
...
function togglecccno(){
    
    
    
   if($('#showtypedccc:checkbox:checked').length > 0){
  //showtargets 
