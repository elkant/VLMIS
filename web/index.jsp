...
function ConfirmDeleteVisit(visit_id)
    {
      var x = confirm("Are you sure you want to delete the selected visit?");
      if (x)
          return true;
      else
        return false;
...
return accountdb.put(doc); //continue from here
 ...
 function loadVlArtHistory(cc_no){
     ...
     var currdt="<table  class='table table-striped table-bordered'><thead><tr><th colspan='4' style='text-align:center;background-color:gray;' >ARV History</th></tr><tr><th style='width:20%;'>Visit Date</th><th style='width:45%;'>Regimen</th><th style='width:20%;'>TCA</th><th style='width:15%;>Delete</th></tr></thead>";
...
if(dat.doc.ccc_number===cc_no)
    {
        ...
        artcount++;   
        currdt+="<tr><td>"+dat.doc.Last_Clinical_Visit_Date+"</td><td>"+dat.doc.Current_Regimen+"</td><td>"+dat.doc.Next_appointment_Date+"</td><td><label class='btn btn-danger' onClick='confirmDeleteVisit(\""+dat.doc.id_+"\");'>X<label></td></tr>";     
    }       
